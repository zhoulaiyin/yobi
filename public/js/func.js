...
(function(){
     ...
     * @private
     */
    Func.prototype.toggleClass = function (el, name, state) {
        if (el && name) {
            if (el.classList) {
     ...
     * @private
     */
    Func.prototype.css = function(el, prop, val) {
    ...
    Func.prototype.versions = function(){
    ...
    Func.prototype.isMobile = function(){
     ...
     * 事件处理类
     */
    Func.prototype.onEvent = function(obj, action, d){
        obj.attachEvent ? obj.attachEvent("on" + action,
            function(action) {
                d.call(obj, action)
            }) : obj.addEventListener && obj.addEventListener(action, d , u);
    };
    Func.prototype.offEvent = function(el, event, fn) {
        el.removeEventListener(event, fn, captureMode);
    };
    Func.prototype.preventDefault = function(obj) {
     ...
     * 位置信息处理类
     */
    Func.prototype.getAbsolute = function (reference, target) {
        var result = {
    ...
    Func.prototype.getViewport = function (target) {
        ...
        var absolutePosi = Func.prototype.position.getAbsolute(document, target);
        return {
     ...
     * cookie操作
     */
    Func.prototype.setCookie = function(k, v, t) {
    ...
    Func.prototype.getCookie = function(k) {
     ...
     * JS处理ajax请求
     */
    Func.prototype.ajax_get = function(url, fn){
    ...
    Func.prototype.ajax_post = function(url, data, fn){
        var params = '';
    ...
    //加载JS文件
    Func.prototype.ls = function (url, callback) {
    ...
    //获取相邻元素节点
    Func.prototype.siblingElem = function(elem){
        var _nodes = [],
            _elem = elem;
    ...
    Func.prototype.selectChoose = function(id_obj,target_val) {
