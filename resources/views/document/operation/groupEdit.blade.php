        ...
        <div class="layui-row" style="margin-top: 20px;">
            <div id="time_line">
                <form id="start_form" onsubmit="return false;" class="layui-form" role="form">
                    ...
                    <input class="layui-input" type="hidden" name="group_id" id="group_id" value="{{$edit_data['group_id'] or 0}}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input class="layui-input elem-date" type="text" id="sort_order" style="width:100px;" name="sort_order" value="{{$edit_data['sort_order'] or $sort_order}}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                        </div>
                    </div>
