...
class ShopOwnerUnSettleTotal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shop_owner:unsettle_total';
     ...
     * @var string
     */
    protected $description = '统计微店长未结算订单信息';
    ...
    public function handle()
    {
        ...
        if ( $project_data ) {
            ...
            foreach ( $project_data as $value ) {
                ...
                //统计订单
                $url = $value['domain_name'].'/task/shopowner/stat/unsettleTotal';
                ...
                $project_task_schedule->schedule = 'shop_owner:unsettle_total'; //任务调度名称
