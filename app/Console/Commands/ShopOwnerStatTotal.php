...
class ShopOwnerStatTotal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shop_owner:stat_total';
     ...
     * @var string
     */
    protected $description = '统计微店长结算信息';
    ...
    public function handle()
    {
        ...
        if ( $project_data ) {
            ...
            foreach ( $project_data as $value ) {
                ...
                //统计订单
                $url = $value['domain_name'].'/task/shopowner/stat/statTotal';
                ...
                $project_task_schedule->schedule = 'shop_owner:stat_total'; //任务调度名称
